// UPLOADED BY CN-THEMES 

/*! For by C.N.T Modernizr 2.6.2 (Custom Build) | MIT & BSD */
...
$this.attr("title",$this.data("smtTitle"));});function smtTip_fadeIn(){clearInterval(smtTip_delay);smtTip.fadeTo("fast",1);}
$(this).click(function(){var $this=$(this);$this.attr("title",$this.data("smtTitle"));});});};})(jQuery);

/*! photoset-grid - v1.0.1 - Copyright 2014 Jonathan Moore - Style Hatch  */
