...
if (pageTitle == "Not Found"){
    $('.post .text > .title').replaceWith( "<div class='title'>404</div>" );
    $('.post .text > p').replaceWith( "<p align='center'>Sorry, the content you are looking for could not be traced.</p><p align='center' style='font-size:8px!important;'><a href='/'>Return back to homepage</a></p>" );
}}
